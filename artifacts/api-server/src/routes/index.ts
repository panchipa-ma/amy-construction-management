...
// Company profile: any approved user can read (issuer info appears on every
// 見積書/請求書 preview, including those generated by external 職人 users).
// Write is internal-only via requireInternal inside the route file.
