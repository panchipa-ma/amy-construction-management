 ...
 */
export const GetCompanyProfileResponse = zod
  .object({
    name: zod.string(),
    ...
    termsDelivery: zod.string(),
    termsPayment: zod.string(),
    termsValidity: zod.string(),
  })
  .and(
    zod.object({
...
export const UpdateCompanyProfileResponse = zod
  .object({
    name: zod.string(),
    postalCode: zod.string(),
    address: zod.string(),
